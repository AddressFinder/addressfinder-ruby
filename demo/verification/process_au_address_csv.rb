...
def syntax_check
  warn "Syntax: bundle exec ruby address_verification_au_batch.rb <input_file.csv>" unless ARGV.size == 1
...
def process_block(block)
  ...
  results = AddressFinder.address_verification_au_batch(addresses: addresses, paf: "1", gnaf: "1",
    concurrency: 5)
